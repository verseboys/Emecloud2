...
public class BNaviMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button walkBtn2 = (Button) findViewById(R.id.button2);
        walkBtn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void initMapStatus(){
        ...
        //设置标尺500米左右的方法zoom(15)
        //设置地图打开默认位置
        builder.target(new LatLng(22.276392, 113.583235)).zoom(13);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.id_map_one:
                mBaiduMap.setMapType(BaiduMap.MAP_TYPE_NORMAL);
                   break;
            case R.id.id_map_one1:
                mBaiduMap.setMapType(BaiduMap.MAP_TYPE_SATELLITE);
                break;
            case R.id.id_map_one2:
